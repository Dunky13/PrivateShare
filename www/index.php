...
<html lang="en">
	<head>
		...
		<meta name="description" 
			content="Personal Filesharing made by Marc Went">
		<meta name="robots" content="noarchive">
		<title>File Sharing by Marc Went</title>
		<link href="css/reset200802.css" rel="stylesheet">
		<link href="css/style.min.css" rel="stylesheet">
		<link href="css/style-upload.min.css" rel="stylesheet">
	...
	<body>
		...
		<div class="container">
			<div class="jumbotron">
				...
				<p>
					<sub>
						You can also upload screenshots and files directly from your desktop by setting up 
						<a target="_blank" href="http://getsharex.com/">ShareX (Win)</a> or 
						<a target="_blank" href="https://github.com/ArsenArsen/KShare">KShare (Linux/OSX)</a>. 
						You can download the config <a href="https://share.went.io/f/shareXConfig.json">HERE</a>
					</sub>
				</p>
			</div>
